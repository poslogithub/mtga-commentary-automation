...
a = Analysis(['src\\mtgacommentary\\commentary_backend.py'],
             ...
             binaries=[],
             datas=[('src\\mtgacommentary\\readme.txt', '.'), ('src\\mtgacommentary\\config\\defaultSpeaker.json', 'config'), ('src\\mtgacommentary\\LICENSE', 'LICENSE'), ('src\\mtgacommentary\\wav', 'wav')],
             hiddenimports=[],
             hookspath=[],
             hooksconfig={},
             runtime_hooks=[],
